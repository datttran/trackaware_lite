...
@Deprecated("Not being used anymore. Functionality moved to ArriveTab")
class ArriveList extends StatefulWidget {
...
class _ArriveListState extends State<ArriveList> {
