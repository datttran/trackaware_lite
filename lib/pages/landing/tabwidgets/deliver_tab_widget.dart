                              ...
                              decoration: new BoxDecoration(
                                gradient: new LinearGradient(
                                    ...
                                    [
                                      ...
                                      Color(0xcb9deeff).withOpacity(.3)]


                                    : [
                                      Color(0xffe4fff5).withOpacity(.3),
                                      Color(0xcbb3d7e0).withOpacity(.2)],
                                ...
                                children: <Widget>[
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Icon(Entypo.dot_single, color: globals.deliveryList[position].isSelected == true? Color(0xff62ff56) :
                                      Color(0xfff1f8ff).withOpacity(.5),size: 32,)
                                    ],
                                  ),
