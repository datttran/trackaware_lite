class Strings {
  //login
  static const String userNameValidationMessage = "Please enter username";
  static const String passwordValidationMessage = "Please enter password";
  static const String usernameCaps = "USERNAME";
  ...
  //new external tender page
  static const String home = "Home";
  static const String back = "Back";
  static const String newTenderExternal = "New Tender External";

  //keychain
  static const String PERSIST_TOKEN = "persist_token";
  static const String HAS_TOKEN = "has_token";
  static const String DELETE_TOKEN = "delete_token";
  ...
  static const String ORDER_NUMBER = "# Order";
  static const String REF_NUMBER = "# Ref";
  static const String PART_NUMBER = "# Part";
  static const String TRACKING_NUMBER = "# Tracking";
  static const String KEEP_SCANNED_VALUES = "Keep scanned values";
  static const String SEND = "SEND";
  static const String PRIORITY_VALIDATION_MESSAGE = "Unable to fetch priority";

  static const QUANTITY_VALIDATION_MESSAGE = "Please enter quantity";
  ...
  static const TRANSACTION_FAILURE = "Transaction failed";
  static const UNABLE_TO_FETCH_USERS = "Unable to fetch users";
  ...
  static const String TOOL_NUMBER = "# Tool";
  static const String TENDER_PARTS = "Tender Parts";
  ...
  static const String PICKUP_EXTERNAL = "Pickup External";
  static const String PICKUP_PART = "Pick Up Parts";

  static const String PICK_UP_SITE = "Pick Up Site";

  static const String DELIVERY_SITE = "Delivery Site";

  static const String NEW_PICKUP_EXTERNAL = "New Pick Up External";

  static const String NEW_PICKUP_PART = "New Pick Up Part";
  static const String NO_PICKUP_ITEMS = "No pick up items found!";

  static const String NO_ARRIVE_ITEMS = "No arrive items";

  static const String SUBMIT = "SUBMIT";

  static const String ARRIVE_LOWERCASE = "arrive";
  static const String DEPART_LOWERCASE = "depart";

  static const String DELIVERY_FAILURE = "Update of delivery status failed";

  static const String DELIVERY_COMPLETE = "Delivery Complete";

  static const String PACKAGING_COUNT = "Packaging Count";

  static const String ENTER_PACKAGING_COUNT = "Enter Packaging Count";

  static const String NO_DEPART_ITEMS = "No depart items";

  //Settings
  static const String SETTINGS = "Settings";
  static const String TABS = "Tabs";
  static const String GPS_POLL_INTERVAL = "Gps Poll Interval";
  static const String GPS_POST_INTERVAL = "Gps Post Interval";
  static const String GPS_URL = "Gps Url";
  static const String ENTER_GPS_POLL_INTERVAL = "Enter Gps Poll Interval";
  static const String ENTER_GPS_POST_INTERVAL = "Enter Gps Post Interval";
  static const String ENTER_GPS_URL = "Enter Gps Url";
  ...
  static const String TENDER_MODE = "Tender Mode";

  static const String TENDER_PRODUCTION_PARTS = "Tender Production Parts";
  static const String TENDER_EXTERNAL_PACKAGES = "Tender External Packages";
  static const String PICKUP_PRODUCTION_PARTS = "PickUp Production Parts";
  ...
  static const String SIGN_UP_QUESTION = "Sign Up ?";

  static const String ENTER_EMAIL = "Enter Email";

  static const String ENTER_USERNAME = "Enter UserName";

  static const String ENTER_FIRST_NAME = "Enter First Name";
  ...
  static const String USER_NAME_HEADING = "UserName";

  static const String PASSWORD = "Password";

  static const String UNABLE_TO_SIGN_UP = "Unable to sign up";

  static const String UNABLE_SEND_EMAIL = "Unable to send email";

  static const String FORGOT_PWD_TITLE = "Forgot Password";

  static const String PICK_LOCATION = "Pick Location";

  static const NO_PICKUP_ITEMS_FOR_DELIVERY = "No items for delivery";

  static const UPDATE_FAILED = "Update failed";

  static const NEXT = "Next";

  static const SIGNATURE = "Signature";

  static const PLEASE_SIGN_TO_PROCEED = "Please sign to proceed";

  //server config
  static const String BASE_URL = "Base Url";
  ...
  static const PLEASE_PICK_DESTINATION = "Please pick destination";

  static const PLEASE_PICK_PICKUP_SITE = "Please pick pickup site";

  static const PLEASE_PICK_DELIVERY_SITE = "Please pick delivery site";

  static const PLEASE_PICK_PRIORITY = "Please pick priority";

  static const SCAN = "Scan";

  static const PICK_SCAN_ITEM = "Pick scan item";

  static const ORDER_NUMBER_SCAN = "Order Number";
  static const PART_NUMBER_SCAN = "Part Number";
  static const TOOL_NUMBER_SCAN = "Tool Number";
  static const REF_NUMBER_SCAN = "Ref Number";
  static const TRACKING_NUMBER_SCAN = "Tracking Number";
  static const DETAILS = "Details";

  static const USER_NAME_CANNOT_BE_EMPTY = "Username cannot be empty";

  static const USE_TOOL_NUMBER = "Use tool number";
